      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm text-amber-200/80">
            ...
            <li><Link href="/events" className="hover:text-[#D4A017] transition-colors">Events</Link></li>
            <li><a href="https://rusticrevivalclothingco.com/collections/annie-oakley-rescue" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4A017] transition-colors">Shop Apparel</a></li>
          </ul>
        </div>
