    ...
    <div className="bg-amber-50 min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto px-4 py-12 flex flex-col gap-10">
        ...
        <p className="text-center text-stone-400 text-sm">
          Questions? Call <a href="tel:4064890382" className="text-[#D4A017] hover:underline">(406) 489-0382</a> or <a href="tel:4064780042" className="text-[#D4A017] hover:underline">(406) 478-0042</a>
        </p>
      </form>
    </div>
  )
